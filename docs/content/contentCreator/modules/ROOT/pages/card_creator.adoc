...
Inside text-based blocks such as `custom`, you can use a few special formatting helpers. `%nbsp:X%` inserts multiple spaces, where `X` is the number of spaces to add, and `%lf%` inserts a line break.
